# Stand alone file that tests the stochastic indicator using a random forest regressor
''' 
Script to test the stochastic indicator using a random forest regressor
To run this file, use the following command:
python stoch-test.py --k_period 14 --d_period 3 --forecast 5
you can insert your own values for k_period, d_period, and forecast
The forecast is the amount of minutes in the future you wish to predict
'''
import numpy as np
import pandas as pd
import talib as ta
